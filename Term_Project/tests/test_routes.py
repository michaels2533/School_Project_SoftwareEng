...
# def test_createApplication(request,test_client,init_database):
#     """
...
#       #first login
#     response = test_client.post('/login', 
#                            data=dict(username='faculty1', password='1234',remember_me=False),
#                            follow_redirects = True)
#     assert response.status_code == 200
...
# def test_withdrawApplication(request,test_client,init_database):
#     response = test_client.post('/login', 
#                           data=dict(username='sakire', password='1234',remember_me=False),
#                           follow_redirects = True)
#     assert response.status_code == 200

# def test_display_profile(request,test_client,init_database):
#     response = test_client.post('/login', 
#                           data=dict(username='sakire', password='1234',remember_me=False),
#                           follow_redirects = True)
#     assert response.status_code == 200
...
# def test_appliedStatus(request,test_client,init_database):
#     response = test_client.post('/login', 
#                           data=dict(username='sakire', password='1234',remember_me=False),
#                           follow_redirects = True)
#     assert response.status_code == 200

# def test_applicationStatus(request,test_client,init_database):
#     response = test_client.post('/login', 
#                           data=dict(username='sakire', password='1234',remember_me=False),
#                           follow_redirects = True)
#     assert response.status_code == 200

# def test_updateApplication(request,test_client,init_database):
